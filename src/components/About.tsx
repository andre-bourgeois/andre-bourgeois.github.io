      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-10">
            ...
            {[
              { Icon: Building, title: "Smart Buildings", description: "Designing intelligent systems that adapt to human needs and environmental conditions." },
              { Icon: Cpu, title: "Internet of Things", description: "Creating connected ecosystems that turn data into actionable insights." },
              { Icon: Bot, title: "Robotics", description: "Researching autonomous coordination and control in multi-agent systems." },
              { Icon: BrainCircuit, title: "Artificial Intelligence", description: "Exploring the applications and impacts of generative and edge AI." },
              { Icon: Users, title: "Technology Leadership", description: "Guiding teams and organisations through complex technology decisions." },
              { Icon: Lightbulb, title: "Innovation Strategy", description: "Making sense of emerging technology and its real-world opportunities." },
            ].map(({ Icon, title, description }, i) => (
              <div key={i} className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="mb-4 w-fit text-transparent bg-clip-text bg-gradient-to-br from-[#F24F22] via-[#ED1A25] via-40% to-[#314CA3]">
                  <Icon className="w-8 h-8 stroke-[1.5] text-current" />
                </div>
